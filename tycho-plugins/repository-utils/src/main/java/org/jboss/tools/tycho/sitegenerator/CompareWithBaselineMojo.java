...
public class CompareWithBaselineMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		TargetPlatform baselineTP = resolverFactory.getTargetPlatformFactory().createTargetPlatform(baselineTPStub, new ExecutionEnvironmentConfigurationStub("JavaSE-1.8"), null, null);
